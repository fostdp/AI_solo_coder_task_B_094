...
func TestModernInstruments_MetalDenserThanWood(t *testing.T) {
	...
	glockDensity := stone_comparator.GetMaterialDensity(glock.Material)
	xyloDensity := stone_comparator.GetMaterialDensity(xylo.Material)
...
func TestModernInstruments_UnifiedMaterialStandard(t *testing.T) {
	...
	for _, instType := range instruments {
		...
		e := stone_comparator.GetMaterialElasticMod(inst.Material)
		rho := stone_comparator.GetMaterialDensity(inst.Material)
		nu := stone_comparator.GetMaterialPoisson(inst.Material)
		...
		prop, ok := stone_comparator.GetMaterialProperty(inst.Material)
		if !ok {
...
func TestGetGlockenspielConfig_UnifiedMaterial(t *testing.T) {
	...
	expectedE := stone_comparator.GetMaterialElasticMod("steel")
	expectedRho := stone_comparator.GetMaterialDensity("steel")
	expectedNu := stone_comparator.GetMaterialPoisson("steel")
