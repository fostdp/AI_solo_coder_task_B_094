...
func CompareEras(req model.EraComparisonRequest) (*model.EraComparison, error) {
	...
	ancientE := stone_comparator.GetMaterialElasticMod("limestone")
	ancientNu := stone_comparator.GetMaterialPoisson("limestone")
	ancientRho := stone_comparator.GetMaterialDensity("limestone")
	...
	modernE := stone_comparator.GetMaterialElasticMod(modern.Material)
	modernNu := stone_comparator.GetMaterialPoisson(modern.Material)
	modernRho := stone_comparator.GetMaterialDensity(modern.Material)
...
func GetGlockenspielConfig() model.GlockenspielConfig {
	...
	return model.GlockenspielConfig{
		Type:        g.Type,
		Material:    g.Material,
		ElasticMod:  stone_comparator.GetMaterialElasticMod(g.Material),
		Poisson:     stone_comparator.GetMaterialPoisson(g.Material),
		Density:     stone_comparator.GetMaterialDensity(g.Material),
		LengthRatio: 0.8,
